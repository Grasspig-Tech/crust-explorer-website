    ...
    <div class="login_page" id="login_page">
		...
		<div class="login_cont">
			...
			<div class="board">
				...
				<el-tabs v-model="activeName">
					...
					<el-tab-pane :label="$t('login.normalLogin')" name="account_login" class="login_title">
						<el-form
							...
							class="loginForm"
							label-position="left"
							:label-width="$i18n.locale === 'en' ? '96px' : '80px'"
						>
							<el-form-item prop="userName" class="user_name_label" :label="$t('login.userName') + ':'">
								<el-input
						...
						>
							...
							<el-form-item prop="code" :label="$t('login.verificationCode') + ':'">
								<div class="code_wrap">
									...
									></el-input>
									<el-button type="primary" class="code_btn" v-if="!isDisable">{{$t('login.getCode')}}</el-button>
				...
				<el-button type="primary" class="login_btn whole_width" :loading="loading">{{$t('login.logIn')}}</el-button>
			</div>
		</div>
    </div>
</template>
